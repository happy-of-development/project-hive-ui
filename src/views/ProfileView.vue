      ...
      <form class="col-md-4"  @submit="onSubmit" novalidate>
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="col-12justify-content-center" style="height: 1.5rem">
          ...
          <div class="col-12">
            ...
            <div class="col-12justify-content-center" style="height: 1.5rem" v-bind:class="{'d-none' : !modifyMode}"></div>
          </div>
          <div class="col-12">
            <div class="input-group">
            ...
            <div class="col-12justify-content-center" style="height: 1.5rem" v-bind:class="{'d-none' : !modifyMode}">
